...
";
            ...
            Assert.AreEqual(expectedContent, File.ReadAllText(Path.Combine(testProjectDirectory, "AssemblyInfo.cs")));
        }
...
";
            ...
            Assert.AreEqual(expectedContent, File.ReadAllText(Path.Combine(testProjectDirectory, "AssemblyInfo.vb")));
        }
...
";
            ...
            Assert.AreEqual(expectedContent, File.ReadAllText(Path.Combine(testProjectDirectory, "My Project", "AssemblyInfo.vb")));
        }
