...
$propsFileUri = New-Object System.Uri -ArgumentList (Join-Path (Join-Path $installPath 'build') '${TargetsFile}.props')
...
$targetsFileUri = New-Object System.Uri -ArgumentList (Join-Path (Join-Path $installPath 'build') '${TargetsFile}.targets')
